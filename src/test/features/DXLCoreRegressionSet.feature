...
Feature: DXLCore
  ...
  @CORE-TC0002
  Scenario Outline: Kargo sürecinin başlanması için createShipment metotunda adres alanın eksik olması durumu
  ...
  @CORE-TC0004
  Scenario Outline: Kargo sürecinin başlanması için createShipment ref no olmadan metotu tetiklenmesi
