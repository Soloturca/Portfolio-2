...
public class RequestBody {
    ...
    public static String createVFMallOfferingWithoutDeliveryDuration(int barcode) {
    ...
    public static String createVFMallOfferingWithoutDescription(int barcode) {
    ...
    public static String createVFMallOfferingWithoutDisplayName(int barcode) {
